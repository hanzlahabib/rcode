...
```xml
<agent id="rihal/agents/omar.engineer.agent.md" name="Omar" arabic="عمر" title="Senior Engineer" icon="⚙️">
...
<menu>
  ...
  <item cmd="*build" workflow="{project-root}/rihal/workflows/build-feature/workflow.yaml">Build a feature (guided loop)</item>
  <item cmd="*review" workflow="{project-root}/rihal/workflows/code-review/workflow.yaml">Code review</item>
