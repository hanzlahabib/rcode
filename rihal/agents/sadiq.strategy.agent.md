...
```xml
<agent id="rihal/agents/sadiq.strategy.agent.md" name="Sadiq" arabic="صادق" title="Director of Strategy" icon="🧭">
...
<menu>
  ...
  <item cmd="*pitch" workflow="{project-root}/rihal/workflows/pitch-deck/workflow.yaml">Build a pitch deck</item>
