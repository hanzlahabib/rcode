...
For complete patterns with grep examples, file-type specifics, and advanced verification strategies, see `/rihal/v2/references/verification-patterns.md` (detailed reference).
