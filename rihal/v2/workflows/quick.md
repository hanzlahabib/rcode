<purpose>
Execute small, ad-hoc tasks with Rihal guarantees (atomic commits, STATE.md tracking). Quick mode spawns rihal-planner (quick mode) + rihal-executor(s), tracks tasks in `.planning/quick/`, and updates STATE.md's "Quick Tasks Completed" table.
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Rihal ► QUICK TASK (DISCUSS + RESEARCH + FULL)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Rihal ► QUICK TASK (DISCUSS + RESEARCH)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Rihal ► QUICK TASK (RESEARCH + FULL)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```bash
INIT=$(node .rihal/bin/rihal-tools.cjs init quick "$DESCRIPTION")
if [[ "$INIT" == @file:* ]]; then INIT=$(cat "${INIT#@file:}"); fi
AGENT_SKILLS_PLANNER=$(node .rihal/bin/rihal-tools.cjs agent-skills rihal-planner 2>/dev/null)
AGENT_SKILLS_EXECUTOR=$(node .rihal/bin/rihal-tools.cjs agent-skills rihal-executor 2>/dev/null)
AGENT_SKILLS_CHECKER=$(node .rihal/bin/rihal-tools.cjs agent-skills rihal-checker 2>/dev/null)
AGENT_SKILLS_VERIFIER=$(node .rihal/bin/rihal-tools.cjs agent-skills rihal-verifier 2>/dev/null)
```

Parse JSON for: `planner_model`, `executor_model`, `checker_model`, `verifier_model`, `commit_docs`, `branch_name`, `quick_id`, `slug`, `date`, `timestamp`, `quick_dir`, `task_dir`, `roadmap_exists`, `planning_exists`.

**If `roadmap_exists` is false:** Error — Quick mode requires an active project with ROADMAP.md. Run `/rihal:new-project` first.
...
Spawn rihal-executor with plan reference:
...
```bash
node .rihal/bin/rihal-tools.cjs commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
...
Rihal > QUICK TASK COMPLETE (FULL MODE)
...
Ready for next task: /rihal:quick ${Rihal_WS}
```
