...
- IF A: Invoke the `rihal-advanced-elicitation` skill, and when finished redisplay the menu
- IF P: Invoke the `rihal-party-mode` skill, and when finished redisplay the menu
