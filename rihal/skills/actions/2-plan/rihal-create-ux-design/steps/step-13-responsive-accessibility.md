...
- When 'A' selected: Invoke the `rihal-advanced-elicitation` skill
- When 'P' selected: Invoke the `rihal-party-mode` skill
...
- Invoke the `rihal-advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `rihal-party-mode` skill with the current responsive/accessibility strategy
