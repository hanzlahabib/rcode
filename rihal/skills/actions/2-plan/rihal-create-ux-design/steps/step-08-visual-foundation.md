...
- Invoke the `rihal-advanced-elicitation` skill with the current visual foundation content
...
- Invoke the `rihal-party-mode` skill with the current visual foundation
