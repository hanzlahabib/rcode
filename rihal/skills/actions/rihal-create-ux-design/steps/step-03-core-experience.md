...
- Invoke the `rihal-advanced-elicitation` skill with the current core experience content
...
- Invoke the `rihal-party-mode` skill with the current core experience definition
