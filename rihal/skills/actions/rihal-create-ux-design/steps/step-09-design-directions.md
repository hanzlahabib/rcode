...
- Invoke the `rihal-advanced-elicitation` skill with the current design direction content
...
- Invoke the `rihal-party-mode` skill with the current design direction
