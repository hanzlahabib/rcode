...
- Invoke the `rihal-advanced-elicitation` skill with the current defining experience content
...
- Invoke the `rihal-party-mode` skill with the current defining experience
