...
- Invoke the `rihal-advanced-elicitation` skill with the current design system content
...
- Invoke the `rihal-party-mode` skill with the current design system choice
