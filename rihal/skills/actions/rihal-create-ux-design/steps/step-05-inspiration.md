...
- Invoke the `rihal-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `rihal-party-mode` skill with the current inspiration analysis
