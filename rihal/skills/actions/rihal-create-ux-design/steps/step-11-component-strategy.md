...
- Invoke the `rihal-advanced-elicitation` skill with the current component strategy content
...
- Invoke the `rihal-party-mode` skill with the current component strategy
