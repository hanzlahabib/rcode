...
```bash
INIT=$(node ".rihal/bin/rihal-tools.cjs" init todos)
...
node ".rihal/bin/rihal-tools.cjs" commit "docs: start work on todo - [title]" --files .planning/todos/completed/[filename] .planning/STATE.md
```
