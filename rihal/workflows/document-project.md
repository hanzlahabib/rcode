...
```
If .rihal/DOCS-AUDIT.md exists, read it and check for missing/stale docs.
The audit output is generated by this workflow's earlier steps; load the
file at runtime via:  cat .rihal/DOCS-AUDIT.md
```
