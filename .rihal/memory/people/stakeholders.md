...
- **Time zone:** global
- **Notes:** primary audience is solo devs and startup teams. Personas (Sadiq, Waleed, Dalil, etc.) keep Arabic names as brand vocabulary — universally usable, not Rihal-only.

### Rihal team (internal) — institutional knowledge consumers

- **Owns:** Rihal-specific brain content pulled into every install via `.rihal/brain/`
- **Comm:** Slack (Rihal workspace)
- **Response cadence:** day-of for active projects
- **Time zone:** GMT+4 (Oman)
- **Notes:** rcode evolved as a personal side-project that ships Rihal's PR/commit/architecture standards. The `.rihal/brain/sources.yaml` file points at upstream Rihal repos.
