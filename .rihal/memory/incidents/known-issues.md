...
- **Symptom:** `wc -l .rihal/workflows/*.md` shows several files >500 lines (`autonomous.md` 1059, `complete-milestone.md` 836, `council.md` 567, `code-review.md` 597, `code-review-fix.md` 529)
- **Surface:** `rihal/workflows/*.md`
...
- **Surface:** `rihal/skills/agents/*/SKILL.md`
...
### `.rihal/agents/` and `.rihal/context/` are untracked install artefacts

- **Symptom:** `git status` always shows these as untracked in this repo
- **Surface:** `.rihal/agents/`, `.rihal/context/`
