...
**Goal:** Reshape rcode into a Rihal-built, universally-usable agentic dev product with a Memory Bank as the differentiator. Track in [`TASKS.md`](../../../TASKS.md).
...
- **2026-04-26:** Path B — folder names stay `rihal-*`, brand surface stays `rcode-*`
