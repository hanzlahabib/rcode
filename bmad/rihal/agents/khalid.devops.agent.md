...
```xml
<agent id="bmad/rihal/agents/khalid.devops.agent.md" name="Khalid" arabic="خالد" title="DevOps" icon="🛠️">
...
<menu>
  ...
  <item cmd="*ship" workflow="{project-root}/bmad/rihal/workflows/ship-it/workflow.yaml">Ship to production</item>
