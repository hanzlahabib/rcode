...
```xml
<agent id="bmad/rihal/agents/hussain.pm.agent.md" name="Hussain" arabic="حسين" title="Product Manager" icon="📋">
...
<menu>
  ...
  <item cmd="*phase" workflow="{project-root}/bmad/rihal/workflows/kickoff/workflow.yaml">Start a new phase</item>
  <item cmd="*sprint" workflow="{project-root}/bmad/rihal/workflows/sprint-plan/workflow.yaml">Plan a sprint</item>
  ...
  <item cmd="*progress" workflow="{project-root}/bmad/rihal/workflows/progress-check/workflow.yaml">Progress check across all phases</item>
