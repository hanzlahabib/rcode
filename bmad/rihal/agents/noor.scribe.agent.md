...
```xml
<agent id="bmad/rihal/agents/noor.scribe.agent.md" name="Noor" arabic="نور" title="Scribe" icon="📖">
...
<menu>
  ...
  <item cmd="*pitch" workflow="{project-root}/bmad/rihal/workflows/pitch-deck/workflow.yaml">Create a pitch deck</item>
