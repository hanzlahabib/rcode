...
<process>
Execute the sprint-planning workflow from @.rcode/workflows/sprint-planning.md end-to-end.
Use rcode-tools.cjs for state operations (sprint add, story add, sprint start, sprint velocity).
