...
**When to use:**
- You have finished `/rcode-execute <phase>` and `/rcode-verify-phase <phase>` passed
...
- You are inside the rcode framework repo itself (no phases exist here)
- Your project uses `git.branching_strategy: none` and you commit directly to main
</objective>

<execution_context>
@.rcode/workflows/ship.md
</execution_context>

<process>
Execute the ship workflow from @.rcode/workflows/ship.md end-to-end.
</process>
