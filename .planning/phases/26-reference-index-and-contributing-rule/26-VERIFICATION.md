...
Add `rcode/references/REFERENCES_INDEX.md` catalogue and "Agent File Size Rule" to CONTRIBUTING.md.

## Must-Have Truths

| # | Truth | Status | Evidence |
|---|-------|--------|----------|
| 1 | `rcode/references/REFERENCES_INDEX.md` exists and catalogs cluster references with loading agents | VERIFIED | File present at `rcode/references/REFERENCES_INDEX.md` (67 lines); 17 rows in Cluster References table covering all cluster reference files added in phases 22-23; `auditor-shared-checklists.md` present with 6 loading agents |
...
| 3 | Rule text includes ">100 lines", "rcode/references/", "@-include" | VERIFIED | Line 212: "exceeds 100 lines"; line 215: "`rcode/references/<name>-playbook.md`"; lines 216, 221: "@-include" and "`@-include`" both present |
...
|----------|--------|-------------|-------|------------|--------|
| `rcode/references/REFERENCES_INDEX.md` | Yes | Yes — 67 lines, 17 cluster refs, 2 universal ref sections, 2 workflow refs, size-exception table | Yes — cross-referenced from CONTRIBUTING.md "Agent File Size Rule" footer | N/A (static doc) | VERIFIED |
...
ls rcode/references/REFERENCES_INDEX.md → exists, 67 lines
