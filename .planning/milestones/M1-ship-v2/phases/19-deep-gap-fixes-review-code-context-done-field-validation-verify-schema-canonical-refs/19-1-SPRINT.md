...
must_haves:
  truths:
    ...
    - "rihal/templates/VALIDATION.md exists and is non-empty"
  ...
  key_links:
    ...
    - from: "GH #495"
      to: "rihal/templates/VALIDATION.md"
