...
must_haves:
  truths:
    ...
    - "rihal/templates/summary.md has Patterns Established, Provides, Requires, Affects sections"
  ...
  artifacts:
    ...
    - path: "rihal/workflows/execute.md"
      provides: "run_verify_commands step"
    - path: "rihal/templates/summary.md"
      provides: "4 new knowledge-transfer sections"
    - path: "rihal/workflows/execute-sprint.md"
