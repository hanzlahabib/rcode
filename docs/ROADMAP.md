...
**Goal:** Running `/rihal:progress` or `/rihal:status` on any project feels instantaneous and actionable — pre-computed CLI output, surfaced insights, and an intent-based Next Up menu instead of a single suggestion.
