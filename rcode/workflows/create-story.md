...
<purpose>
Convert a single story from an EPIC file into a self-contained STORY.md file. This story is ready for `/rcode-dev-story` to be wrapped for AI-coder execution. Entry is gated by checklist-story-draft.md.
</purpose>
...
```
/rcode-create-story <argument-here>
```

**Examples:**
```
/rcode-create-story example 1
/rcode-create-story example 2
```
...
```
Usage: /rcode-create-story <EPIC-file.md> [--story <id>]

Examples:
  /rcode-create-story .planning/epics/EPIC-01.md
  /rcode-create-story .planning/epics/EPIC-01.md --story EPIC-01.1
```
...
**During development:** See `/rcode-dev-story` to wrap this STORY.md for AI-coder execution.
...
**Ready for:** /rcode-dev-story → /rcode → Definition of Done verification
```
...
Next step: /rcode-dev-story .planning/stories/{story-id}.md
```
