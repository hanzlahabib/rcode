...
```
/rcode-profile-user <argument-here>
```

**Examples:**
```
/rcode-profile-user
/rcode-profile-user --json '{"communication":"Direct & dense","autonomy":"Autonomous","domain_depth":"Advanced","iteration_speed":"Fast"}'
```
...
This profile will personalize future /rcode-council and /rcode-execute responses.
```
