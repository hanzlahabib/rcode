...
```
/rcode-dashboard [--port <N>] [--no-open]
```

**Examples:**
```
/rcode-dashboard                  # start on port 7717, open browser
/rcode-dashboard --port 8080      # use a different port
/rcode-dashboard --no-open        # don't auto-open the browser
```
