...
|------|-------------|-------|
| CP | Expert-led facilitation to produce your Product Requirements Document | rcode-create-prd |
| VP | Validate a PRD is comprehensive, lean, well-organized, and cohesive | rcode-validate-prd |
| EP | Update an existing Product Requirements Document | rcode-edit-prd |
| CE | Create the Epics and Stories listing that will drive development | rcode-create-epics-and-stories |
| IR | Ensure PRD, UX, Architecture, and Stories are all aligned | rcode-check-implementation-readiness |
...
4. **Present the capabilities table** and remind them they can invoke `rcode-help`.
