...
|------|-------------|-------|
| DP | Generate comprehensive project documentation (brownfield analysis, architecture scanning) | skill: rcode-document-project |
...
### Happy Path
**Input:** "Write the README for this rcode module"
