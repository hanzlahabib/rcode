...
|------|-------------|-------|
| BP | Expert-guided brainstorming facilitation | rcode-brainstorming |
| MR | Market analysis, competitive landscape, customer needs and trends | rcode-market-research |
| DR | Industry domain deep dive, subject matter expertise and terminology | rcode-domain-research |
| TR | Technical feasibility, architecture options and implementation approaches | rcode-technical-research |
| CB | Create or update product briefs through guided or autonomous discovery | rcode-product-brief |
| DP | Analyze an existing project to produce documentation for humans and LLMs | rcode-document-project |
