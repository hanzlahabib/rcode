...
Detailed dispatch matrix, identity, and rcode context awareness for [`SKILL.md`](SKILL.md).
...
| Clone a website | Haitham (invokes `rcode-clone-website`) |
...
- **rcode SaaS products** — Jadawal, Eysal, Hassad, Iqraa.
