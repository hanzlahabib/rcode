...
If any of the above is missing and the session is NOT running with `.rcode/config.yaml` `mode: yolo` or `/rcode-do --auto`, the workflow MUST halt and ask the user — never fabricate numbers.
