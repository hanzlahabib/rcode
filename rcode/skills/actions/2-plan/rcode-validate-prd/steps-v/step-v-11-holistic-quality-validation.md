...
Assess the PRD as a cohesive, compelling document - evaluating document flow, dual audience effectiveness (humans and LLMs), rcode PRD principles compliance, and overall quality rating.
...
- 🎯 Evaluate document flow, dual audience, rcode principles
...
Invoke the `rcode-advanced-elicitation` skill
...
**3. rcode PRD Principles Compliance:**
...
- Check rcode principles compliance
...
### rcode PRD Principles Compliance
...
- rcode PRD principles compliance checked
...
- Not checking all rcode principles
