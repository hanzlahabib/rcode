...
validationWorkflow: '{project-root}/_rcode-skills/2-plan-workflows/create-prd/steps-v/step-v-01-discovery.md'
---
...
**PRD Status:**
- Format: {rcode Standard / rcode Variant / Legacy (converted)}
