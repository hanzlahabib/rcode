...
- Invoke the `rcode-advanced-elicitation` skill with the current visual foundation content
...
- Invoke the `rcode-party-mode` skill with the current visual foundation
