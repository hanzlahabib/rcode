...
- Invoke the `rcode-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `rcode-party-mode` skill with the current inspiration analysis
