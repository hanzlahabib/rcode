...
- Invoke the `rcode-advanced-elicitation` skill with the current emotional response content
...
- Invoke the `rcode-party-mode` skill with the current emotional response definition
