...
#### Menu Handling Logic:
- IF A: Invoke the `rcode-advanced-elicitation` skill, and when finished redisplay the menu
- IF P: Invoke the `rcode-party-mode` skill, and when finished redisplay the menu
