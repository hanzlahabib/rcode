...
- **Writes:** the sharded output files only; does NOT modify `.rcode/memory/`. If the sharded doc is a Memory Bank file, use `rcode-memory-distill` instead.
