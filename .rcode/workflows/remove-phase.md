...
- Example: `/rcode-remove-phase 17` → phase = 17
- Example: `/rcode-remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /rcode-remove-phase <phase-number>
Example: /rcode-remove-phase 17
```
...
To abandon current work, use /rcode-pause-work instead.
```
...
- Renaming all files inside renumbered directories (SPRINT.md, SUMMARY.md, etc.)
...
Would you like to:
- `/rcode-progress` — see updated roadmap status
