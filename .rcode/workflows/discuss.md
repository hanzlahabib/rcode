...
- [ ] Session recorded in `state.json` via rcode-tools.cjs
...
- **`rcode-tools.cjs` not found:** tell the user to run `npx @hanzlaa/rcode install` (or `rcode install` if installed globally).
