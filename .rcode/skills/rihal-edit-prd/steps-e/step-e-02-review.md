...
prdPurpose: '{project-root}/_rihal-skills/2-plan-workflows/create-prd/data/prd-purpose.md'
---
...
2. Analyze against Rihal standards (from prd-purpose.md)
...
- IF A: Invoke the `rihal-advanced-elicitation` skill, then return to discussion
- IF P: Invoke the `rihal-party-mode` skill, then return to discussion
