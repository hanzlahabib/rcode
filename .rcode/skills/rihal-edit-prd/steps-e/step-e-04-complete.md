...
validationWorkflow: '{project-root}/_rihal-skills/2-plan-workflows/create-prd/steps-v/step-v-01-discovery.md'
---
...
**PRD Status:**
- Format: {Rihal Standard / Rihal Variant / Legacy (converted)}
