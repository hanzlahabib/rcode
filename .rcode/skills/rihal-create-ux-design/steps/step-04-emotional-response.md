...
- Invoke the `rihal-advanced-elicitation` skill with the current emotional response content
...
- Invoke the `rihal-party-mode` skill with the current emotional response definition
