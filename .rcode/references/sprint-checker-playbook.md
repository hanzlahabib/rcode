...
<upstream_input>
**CONTEXT.md** (if exists) — User decisions from `/rcode-discuss-phase`
...
**The difference:**
- `rcode-verifier`: Verifies code DID achieve goal (after execution)
- `rcode-sprint-checker`: Verifies sprints WILL achieve goal (before execution)
...
| When you need... | Read |
|---|---|
| Full dimension definitions with examples, checks, output formats | `.rcode/agents-rules/sprint-checker/dimensions.md` |
| Step-by-step verification process (Steps 1-9.5) | `.rcode/agents-rules/sprint-checker/process.md` |
